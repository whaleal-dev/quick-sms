...
1. 先读 [短信概念总览](./concepts/overview.md)（出站 / 入站 / Report / Webhook）
2. [Spring Boot 快速开始](./getting-started/quickstart-spring-boot.md)
3. 或 [JavaSE 快速开始](./getting-started/quickstart-java.md)
4. 按厂商核对凭证字段：[厂商接入说明](./guide/providers.md)
