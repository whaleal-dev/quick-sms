 ...
 * @since 2026-07-29
 */
public class CloopenReceiptParser implements ReceiptParser {
    ...
    public SmsReceipt parse(Map<String, Object> rawData, SmsProviderConfig config) {
        ...
        String status = first(rawData, new String[]{"status", "statusCode"});
        return SmsReceipt.builder()
                ...
                .to(first(rawData, new String[]{"to", "mobile"}))
