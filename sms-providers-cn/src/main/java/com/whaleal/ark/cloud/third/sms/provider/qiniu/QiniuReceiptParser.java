 ...
 * @since 2026-07-29
 */
public class QiniuReceiptParser implements ReceiptParser {
    ...
    public SmsReceipt parse(Map<String, Object> rawData, SmsProviderConfig config) {
        ...
        return SmsReceipt.builder()
                .receiptId(first(rawData, new String[]{"message_id", "msg_id"}))
                .messageId(first(rawData, new String[]{"message_id", "msg_id"}))
                ...
                .providerType(SmsProviderType.QINIU)
                .rawData(rawData)
                .build();
    }
