 ...
 * @since 2026-07-29
 */
public class ChuanglanReceiptParser implements ReceiptParser {
    ...
    public SmsReceipt parse(Map<String, Object> rawData, SmsProviderConfig config) {
        ...
        String status = first(rawData, new String[]{"status", "statusDesc"});
        return SmsReceipt.builder()
                .receiptId(first(rawData, new String[]{"msgid", "msgId"}))
                .messageId(first(rawData, new String[]{"msgid", "msgId"}))
