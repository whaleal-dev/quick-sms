 ...
 * @since 2026-07-29
 */
public class BaiduReceiptParser implements ReceiptParser {
    ...
    public SmsReceipt parse(Map<String, Object> rawData, SmsProviderConfig config) {
        ...
        String status = first(rawData, new String[]{"status", "code"});
        return SmsReceipt.builder()
                .receiptId(first(rawData, new String[]{"code", "messageId"}))
                .messageId(first(rawData, new String[]{"code", "messageId"}))
                ...
                .providerType(SmsProviderType.BAIDU)
                .rawData(rawData)
                .build();
    }
