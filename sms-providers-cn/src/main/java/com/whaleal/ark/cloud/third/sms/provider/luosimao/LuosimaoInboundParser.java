 ...
 * @since 2026-07-29
 */
public class LuosimaoInboundParser implements InboundParser {
    ...
    public SmsInboundMessage parse(Map<String, Object> rawData, SmsProviderConfig config) {
        ...
        return SmsInboundMessage.builder()
                ...
                .to(first(rawData, new String[]{"port", "to"}))
                .content(first(rawData, new String[]{"message", "content"}))
    ...
    public boolean isValidData(Map<String, Object> rawData) {
        return rawData != null && !rawData.isEmpty()
                ...
                && first(rawData, new String[]{"message", "content"}) != null;
    }
